INSERT INTO categories (categoryName, code)
...
VALUES ('test1@gmail.com', 'Кольтира', '123456', '+79111234567'),
       ('test2@yandex.ru', 'Тассариан', '654321', '+79117654321');

INSERT INTO lots (lot_name, categoryId, st_price, path, dt_end, text, bet_step, autor_id)
...
INSERT INTO bets (dt_add, value, user_id, lot_id)
VALUES        (NOW(), '5440', '1', '6'),
              (NOW(), '5480', '1', '6');
...
SELECT  lot_name, st_price, path, c.categoryName, value, l.dt_add, l.winner_id FROM lots l
...
SELECT l.id, lot_name, categoryName FROM lots l /*3*/
JOIN categories c
ON l.id = c.id
WHERE l.id = 1;
